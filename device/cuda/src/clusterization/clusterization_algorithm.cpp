...
host_measurement_container clusterization_algorithm::operator()(
    ...
    *total_clusters = 0;
    ...
    traccc::cuda::cluster_counting(
        num_modules, sparse_ccl_indices, vecmem::get_data(cluster_sizes),
        cluster_prefix_sum, cells_max, m_mr.get());
    ...
    traccc::cuda::component_connection(clusters_buffer, cells_per_event,
    ...
    traccc::cuda::measurement_creation(measurement_buffer, clusters_buffer);
